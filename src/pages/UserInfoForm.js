...
//           selectedChannels,
//           selectedPlatforms,
//           authData: { email: authData.email } // Save email for verification
//         }));
//       } catch (e) {
//         console.error('Failed to save form data:', e);
//       }
...
//   // CHECK: Auto-submit when authenticated user returns
//   useEffect(() => {
//     const checkAndSubmit = async () => {
//       console.log('🔍 Checking auth status:', { isAuthenticated, hasToken: !!localStorage.getItem('token') });
...
//         if (result) {
//           setAuthSuccess('Authentication successful!');
//           // Form data is already in localStorage, useEffect will handle submission
//         }
//       } else {
//         if (!authData.name || !authData.email || !authData.password) {
//           setAuthError('All fields are required');
...
//         // No returnUrl needed - the auto-detection will handle it
//         const result = await signup(authData.email, authData.password, authData.name);
...
//         // If no verification required (shouldn't happen but just in case)
//         setAuthSuccess('Account created successfully!');
//         // Form data is already in localStorage, useEffect will handle submission
//       }
//     } catch (err) {
